  ...
  test: {
    ...
    coverage: {
      ...
      exclude: [
        ...
        'src/hooks/use-sound-feedback.ts',
        'src/hooks/use-statement-pdf.ts',
        'src/hooks/use-task-reminders.ts',
        'src/hooks/use-theme-assets.ts',
        'src/hooks/use-theme.ts',
        'src/hooks/use-toast.ts',
        'src/hooks/use-today-tasks.ts',
        'src/hooks/use-transfers-data.ts',
        'src/hooks/use-url-filters.ts',
        'src/hooks/use-vault-keyboard-shortcuts.ts',
