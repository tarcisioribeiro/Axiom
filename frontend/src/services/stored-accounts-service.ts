...
import type { StoredBankAccount, StoredBankAccountFormData, StoredBankAccountReveal } from '@/types';

class StoredAccountsService extends BaseService<StoredBankAccount, StoredBankAccountFormData> {
  constructor() {
