    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_generated_month', models.CharField(blank=True, max_length=7, null=True, verbose_name='Último Mês Gerado')),
                ...
                ('fixed_expense', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='vault_contribution', to='expenses.fixedexpense', verbose_name='Despesa Fixa Associada')),
                ...
                ('vault', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='recurring_contributions', to='vaults.vault', verbose_name='Cofre')),
            ],
            options={
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['vault', 'is_active'], name='vaults_vrc_vault_active_idx'),
        ),
        migrations.AddIndex(
            model_name='vaultrecurringcontribution',
            index=models.Index(fields=['is_active', 'is_deleted'], name='vaults_vrc_active_del_idx'),
        ),
        migrations.AddField(
